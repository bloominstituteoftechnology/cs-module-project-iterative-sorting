...
class SearchingTests(unittest.TestCase):
    ...
    def test_binary_search(self):
        ...
        self.assertEqual(binary_search(arr1, -8), True)
        self.assertEqual(binary_search(arr1, 0), True)
        self.assertEqual(binary_search(arr2, 6), False)
        self.assertEqual(binary_search(arr2, 0), False)
