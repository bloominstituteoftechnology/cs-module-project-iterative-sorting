...
# different places. The height of the wall is specified by an array H of N positive integers.
#  H[I] is the height of the wall from I to I+1 meters to the right of its left end. 
# In particular, H[0] is the height of the wall's left end and H[N−1] is the height of the wall's 
# right end.
